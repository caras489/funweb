...
// 			spanElem.innerHTML = "사용 불가능한 패스워드";
	...
	function openSearchAddressWindow() {
		window.open("search_address.jsp","","width=400,height=250");
	} // 주소를 검색하는 함수 (새로운 창 search_address.jsp를 띄운다 너비 400 높이 250)
</script>
</head>
<body>
	<div id="wrap">
		  ...
		  <article>
		  	...
		  	<form action="joinPro.jsp" method="post" id="join" name="fr" onsubmit="return checkSubmit()">
		  		<fieldset>
		  			...
		  			<label>User Id</label>
		  			<input type="text" name="id" class="id" id="id" required="required" readonly="readonly" placeholder="영문,숫자 4~16글자">
		  		...
		  		<fieldset>
		  			...
		  			<input type="button" value="search" class="dup" onclick="openSearchAddressWindow()"><br>
		  			<label>Address</label><!-- search 버튼 클릭시 주소를 검색하는 함수호출 -->
